  ...
  async callback(bot, interaction, guild, args, settings) {
    ...
    if (value === null) {
      embed = new EmbedBuilder()
        ...
        .setDescription(
          bot.translate(settings.Language, 'Premium/bassboost:EMBED_DISPLAY_BASSBOOSTLEVEL', {
            VALUE: BassBoost
          })
        );
    } else {
      embed = new EmbedBuilder()
        ...
        .setDescription(
          bot.translate(settings.Language, 'Premium/bassboost:EMBED_SET_NEW_BASSBOOSTLEVEL', {
            VALUE: value
          })
        );
