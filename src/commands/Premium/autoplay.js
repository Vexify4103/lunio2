...
module.exports = class Autoplay extends Command {
     ...
     async callback(bot, interaction, guild, args, settings) {
          ...
          if (choice === 'on') {
               if (player.autoplay) {
                    embed = new EmbedBuilder()
                         ...
                         .setDescription(bot.translate(settings.Language, 'Premium/autoplay:EMBED_AUTOPLAY_ALREADY_TOGGLE', {
               ...
               embed = new EmbedBuilder()
                    ...
                    .setDescription(bot.translate(settings.Language, 'Premium/autoplay:EMBED_AUTOPLAY_ACTIVATED'))
          ...
          if (choice === 'off') {
               ...
               embed = new EmbedBuilder()
                    .setColor(await bot.getColor(bot, guild.id))
                    .setDescription(bot.translate(settings.Language, 'Premium/autoplay:EMBED_AUTOPLAY_DEACTIVATED'))
