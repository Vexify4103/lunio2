...
class Command {
	constructor(bot, {
		...
		this.conf = { guildOnly, userPermissions, nsfw, ownerOnly, premiumOnly, adminOnly, prv, music, reqplayer, reqvc, cooldown, slash, options, methods, defaultPermission, helpPerms, usage, reqVote, flags };
